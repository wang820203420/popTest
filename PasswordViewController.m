...
@property(nonatomic) Password *passwordStrengthIndicatorView;
@end
...
-(void)addPasswordTextField
{
    ...
    self.passwordTextField.placeholder = @"saoasdasd";
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-[_passwordTextField]-|" options:0 metrics:nil views:views]];
    
    
    
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(88)-[_passwordTextField(==36)]" options:0 metrics:nil views:views]];
...
{
    self.passwordStrengthIndicatorView = [Password new];
